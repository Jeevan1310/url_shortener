...
if(isset($email)){
  try{
    ...
    if($check == 0){
      ...
      $passM = md5($password);
      $sql ="insert into users (email,username,password) values ('$email','$username','$passM')";
      $r = $db->exec($sql);
        ...
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            ...
            <form class="form-signin" method="post" action="register.php">
              ...
              <div class="form-label-group">
                <input name="username" type="text" id="inputFname" class="form-control" placeholder="User Name" required autofocus>
              ...
              <div class="custom-control custom-checkbox mb-3">
                ...
                <label class="custom-control-label" for="customCheck1">Show password</label>
                  ...
                  <script>
                      ...
                      const rememberPasswordCheckbox = document.getElementById('customCheck1');
